...
const features = [
  {
    name: 'Français natif • précision 99%*',
    description:
      "Transcription et résumé optimisés pour le français même avec des enregistrements imparfaits. *Sur audio intelligible sans bruit extrême.",
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Sécurité & RGPD — vos données, vos règles',
    description:
      "Serveurs à Paris (France), chiffrement de bout en bout, données non revendues ni réutilisées. Suppression à la demande sous 24h ou automatique après traitement.",
    icon: LockClosedIcon,
  },
  {
    name: 'Universel par design (sans bot)',
    description:
      "Fonctionne avec Google Meet, Teams, Zoom… en capturant l’audio de l’ordinateur (micro + sortie). Pas d\'invité robot à vos réunions.",
    icon: ArrowPathIcon,
  },
  {
    name: 'Compte rendu pro & partage en 1 clic',
    description:
      "Synthèse actionnable, sections claires (décisions, actions, risques) et partage instantané : lien sécurisé, Slack, email, Notion, Monday, ClickUp, Asana.",
...
const tiers = [
  {
    ...
    href: '#checkout',
    priceMonthly: '39€',
    description: 'Pour les pros qui veulent gagner 3–4h/semaine sur leurs comptes rendus.',
    features: [
      'Réunions illimitées',
      'Transcription & résumé en français',
      'Compte rendu pro (modifi able facilement)',
  ...
  },
  {
    ...
    href: '#checkout',
    priceMonthly: '59€',
    description: 'Pour les équipes qui veulent standardiser la qualité des notes et le suivi.',
    features: [
      'Tout Business',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Oui. En salle, utilisez le micro de l’ordinateur ou du téléphone. Sur iPhone, l’app enregistre vos appels et détecte vos évènements agenda pour proposer l’enregistrement automatiquement.",
  },
  {
    id: 5,
    question: 'Quelle précision puis-je attendre ?',
    answer:
      "Jusqu’à 99 % sur un audio intelligible en français. Sur enregistrements très dégradés, notre modèle reste robuste et vous pouvez corriger en un clic.",
  },
  {
    id: 6,
    question: 'Pourquoi pas d’offre gratuite ?',
    answer:
      "Pour garantir confidentialité, support et qualité pro dès le départ. À la place : une garantie satisfait ou remboursé 60 jours, sans condition.",
  },
]
      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl dark:text-white">
                  Le bloc‑notes IA pour enchaîner vos réunions sans rien perdre
                </h1>
                <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                  Vos notes + la transcription deviennent un compte rendu professionnel, prêt à envoyer. Français natif, sécurisé RGPD, serveurs à Paris — sans bot ni plugin.
                </p>
                <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-x-6">
                  ...
                  >
                    Commencer — utiliser mon email pro
                  </a>
                  <a href="#demo" className="text-sm/6 font-semibold text-gray-900 dark:text-white">
                    Voir une démo (2 min) <span aria-hidden="true">→</span>
                  </a>
                </div>
                <p className="mt-3 text-xs text-gray-500 dark:text-gray-400">
                  Emails perso (gmail, yahoo, etc.) refusés • Nom & prénom requis • Garantie satisfait ou remboursé 60 jours
                </p>
              </div>
        ...
        <div id="features" className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-400">Agissez plus vite</h2>
            <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance dark:text-white">
              Tout pour sortir de réunion avec un plan d’action clair
            </p>
            <p className="mt-6 text-lg/8 text-gray-700 dark:text-gray-300">
              Plus de notes dispersées ni de tâches oubliées. Centralisez vos décisions, actions et risques, puis partagez-les en un clic avec l’équipe.
            </p>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-2 text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl dark:text-white">
                100 % payant, 0 % risque — satisfait ou remboursé 60 jours
              </p>
            </div>
            <p className="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-gray-600 sm:text-xl/8 dark:text-gray-400">
              Pas d’essai gratuit, pas d’offre freemium : nous misons tout sur la qualité, la confidentialité et un vrai support. Si ce n’est pas pour vous, on vous rembourse.
            </p>
        ...
        <div className="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl dark:text-white">
              Boostez vos comptes rendus. Passez au plan payant aujourd’hui.
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600 dark:text-gray-300">
              Garantie satisfait ou remboursé 60 jours. Si ce n’est pas un « oui » franc pour votre équipe, on vous rembourse.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#lead" className="text-sm/6 font-semibold text-gray-900 dark:text-white">
                D’abord, laisser mon email pro <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
          <div
