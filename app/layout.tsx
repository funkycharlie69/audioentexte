      ...
      <head>
        ...
        {pixelId && (
          <>
            ...
            fbq('init', '${process.env.NEXT_PUBLIC_META_PIXEL_ID || "798924695922408"}');
            // Deduplicate PageView: only fire once globally
            if (!window.__fbqPV) { fbq('track', 'PageView'); window.__fbqPV = true; }
                `,
              }}
            />
